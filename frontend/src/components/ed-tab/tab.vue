<template>
    <div class="ed-tab" :class="{'ed-tab-fix-bottom': fixBottom}" ref="viewArea">
        <div class="ed-tab-list" :style="style" ref="list">
            <slot></slot>
            <div class="ed-tab-active-bar active"
                v-if="!fixBottom"
    ...
    export default {
        ...
        computed: {
            ...
            style() {
                ...
                if (this.fixBottom) {
                    return {
                        flex: `0 0 ${singWidth * this.items.length}px`   // 兼容ios6
                    };
                } else {
                    return {
                        flex: `0 0 ${singWidth * this.items.length}px`,   //兼容ios6
